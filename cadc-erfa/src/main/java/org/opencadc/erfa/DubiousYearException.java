 ...
 * to call a function with an earlier date.  Such a date is
 * considered dubious.
 * </p>
 ...
 * IYV) is considered dubious.
 * </p>
 */
public class DubiousYearException extends Exception {

    public DubiousYearException(String message) {
        super(message);
    }

    public DubiousYearException(String message, Throwable cause) {
        super(message, cause);
    }
