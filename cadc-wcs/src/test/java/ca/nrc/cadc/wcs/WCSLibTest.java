    ...
    public void testInvalidSpectralKeywords() {
        try {
            ...
            try {
                ...
                Assert.assertEquals("spectral keyword test", "Invalid subimage specification (no spectral axis).(12)",
                                    e.getMessage());
            }
            ...
            try {
                ...
                Assert.assertEquals("spectral keyword test", "Invalid coordinate transformation parameters(6)",
                                    e.getMessage());
            }
