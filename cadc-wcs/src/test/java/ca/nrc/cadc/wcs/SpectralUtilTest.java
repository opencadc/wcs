...
public class SpectralUtilTest {
    ...
    public void testValidCtypesCunits() {
        try {
            String[] ctypes = { "FREQ", "ENER", "WAVN", "VRAD", "WAVE", "VOPT", "ZOPT", "AWAV", "VELO", "BETA", "FREQ",
                "ENER", "WAVN", "VRAD", "WAVE", "VOPT" };
            String[] cunits = { "Hz", "kHz", "MHz", "GHz", "eV", "keV", "MeV", "GeV", "m", "cm", "mm", "um", "µm", "nm",
                "Angstrom", "A" };
            SpectralUtil.isValidCunit(ctypes, cunits);
        } catch (Exception unexpected) {
            log.error("unexpected exception", unexpected);
